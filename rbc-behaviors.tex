...
Few RBC models include viscoelastic forces. Fedosov \latin{et al.}~\cite{Fedosov:2010bc} use a particle-based
...
exhibits tumbling for $\shear=50\persec$ and tank-treading for $\shear=1000\persec$. \Cref{fig:tumble-tread} shows
one period of each.
...
\begin{figure}[tb]
    ...
    \begin{minipage}{0.2\textwidth}
        ...
        $\dot{\gamma}t = 20$
    \end{minipage}%
    \phantomsubcaption\label{fig:tumble}
    \end{subfigure}
    \begin{subfigure}{\textwidth}
    \begin{minipage}{0.2\textwidth}
        \centering
    ...
    \begin{minipage}{0.2\textwidth}
        ...
        $\dot{\gamma}t = 47$
    \end{minipage}%
    \phantomsubcaption\label{fig:tread}
    \end{subfigure}
    \caption{%
