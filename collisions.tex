...
We continue to use the same physical domain as the previous two sections, now with
...
initially separated by a gap of $4h = 0.8\um$ between their convex hulls, \latin{i.e.},
