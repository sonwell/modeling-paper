...
show that this scheme, $Div. - S2$ in their parlance,\marginpar{{\color{tol/vibrant/red}``Use dash not comma.''} They call it ``$Div.-S2$'', so I think --- here would be confusing} is conservative under the assumption
