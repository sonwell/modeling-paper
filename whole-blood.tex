...
Flow profiles are shown in \cref{fig:flow-profiles}. The most notable difference among the three flow profiles is
...
We observe platelets rolling in the flow direction along their edge. Because the platelet in this arrangement is
...
but may also prolong the rolling. \Cref{fig:unicycle}(a)--(d) consists of a series of snapshots illustrating the
...
its edge is \emph{unicycling}. \Cref{fig:unicycle}(e) illustrates that the platelet spends more time in contact or
...
is characterized by deformations that flatten the edge of the platelet and a \midtilde5\% relative change in the
...
Because the platelet comes into contact with the endothelium, or nearly does so, the platelet slows along the area
