...
(Section~\ref{sec:energy} and Appendix~\ref{sec:forces}), and detail the discretization
of the structures to obtain $\X_j$, $\F(\X_j)$, and $\weight[j]$ (Section~%
\ref{sec:rbfs}). However, before we do so, we discuss the specific variant of the IB
